...
public class S1Reg {
   ...
   AuxJNumberInput[] ni = new AuxJNumberInput[9];
   DatanFrame df;  
   ...
   public S1Reg(){  
      ...
      String s = "Polynomial regression on created data";
      ...
      ig.add(ni[1]);
      ni[2] = new AuxJNumberInput("r_max", "maximum number of parameters for plot of fitted polynomial (>=1, <=n)", errorLabel);
      ni[2].setProperties("r_max", true, 1);
