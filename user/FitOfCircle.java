...
public class FitOfCircle {
   ...
   public FitOfCircle(){
      String s = "Fitting a circle to simulated data points (Except for its name, this program is identical to solutions.S7Lsq)";
